...
__How would you change color of the points to the cyl?__
```{r}
ggplot() +
...
How about if we wanted to create a line plot with this data? How would you create the following plots create separate lines based on the "am" variable.
...
Third plot is a stat = density plot.
