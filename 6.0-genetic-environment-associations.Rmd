...
And we might have a raster of a spatially explicit map of population structure, called the genoscape of the Willow Flycatcher.  
...
What we ultimately want to investigate is how environmental variables are correlated with genetic variation. Note, this is *not* to investigate or identify candidate genes, but rather what combination of environmental variables shapes overall population genetic structure of a species.
